...
function Footer() {
    return (
        <div data-scroll data-scroll-section data-scroll-speed='-.7' className='w-full flex gap-44 min-h-screen mt-[50vh] bg-zinc-900 p-20 rounded-t-3xl'>
            <div className='flex flex-col  justify-between'>
                <div className=' heading'>
                    <h1 className='tracking-tight text-8xl uppercase font-semibold'>eye-</h1>
                    <h1 className='tracking-tight text-8xl uppercase font-semibold'>opening</h1>
                </div>
            ...
            <div>
                <h1 className=' text-7xl tracking-tight uppercase font-semibold'>presentations</h1>
                ...
                <div className='flex gap-72'>
                    <div className='flex flex-col mt-10'>
                        <h1 className='mb-4'>L:</h1>
                        <h1>202-1965 W 4th Ave <br /> Vancouver, Canada</h1>
                        <h1 className='mt-4'>30 Chukarina St<br />Lviv, Ukraine</h1>
                    </div>
                    <div className='flex flex-col mt-10'>
                        <h1 className='mb-4'>M:</h1>
                        <a href="#">Home</a>
                        <a href="#">Services</a>
                        <a href="#">Our work</a>
                        <a href="#">About us</a>
                ...
                <div className='flex flex-col mt-10'>
                    <h1 className='mb-4'>E:</h1>
                    <a href="mailto:http://hello@ochi.design">hello@ochi.design</a>
                </div>
                <div className='flex gap-28 mt-12 text-zinc-500'>
                    <div className='flex  '>
                        <h1>© ochi design 2024.</h1>
                        <a href="https://ochi.design/privacy/">Legal Terms</a>
                    </div>
                    <h1 >Website by Suraj Pathak</h1>
                </div>
            </div>
        </div>
    )
